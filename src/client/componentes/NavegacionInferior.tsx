...
export function NavegacionInferior() {
  return <nav aria-label="Navegación principal" className="area-segura-abajo fixed inset-x-0 bottom-0 z-30 select-none border-t border-borde/80 bg-superficie/95 px-2 pt-1.5 backdrop-blur-lg touch-none">
